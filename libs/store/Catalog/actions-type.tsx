export enum ProductActionType {
    ...
    // action types for searching products on the user end
    SEARCH_USER_PRODUCTS = 'catalog/SEARCH_USER_PRODUCTS',
    PRODUCT_USER_SEARCHING_SUCCESS = 'catalog/PRODUCT_USER_SEARCHING_SUCCESS',
    PRODUCT_USER_SEARCHING_FAILED = 'catalog/PRODUCT_USER_SEARCHING_FAILED',
    // end
}
