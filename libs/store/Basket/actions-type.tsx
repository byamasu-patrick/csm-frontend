export enum BasketActionType {
    ...
    //
    // action types for increamenting an item quantity in the basket
    INCREASE_BASKETPRODUCT_BY_PRODUCTID= 'basket/INCREASE_BASKETPRODUCT_BY_PRODUCTID',
    INCREASE_BASKETPRODUCT_BY_PRODUCTID_SUCCESS= 'basket/INCREASE_BASKETPRODUCT_BY_PRODUCTID_SUCCESS',
    INCREASE_BASKETPRODUCT_BY_PRODUCTID_FAILED= 'basket/INCREASE_BASKETPRODUCT_BY_PRODUCTID_FAILED',
    //
    // action types for decreamenting an item quantity in the basket
    DECREASE_BASKETPRODUCT_BY_PRODUCTID= 'basket/DECREASE_BASKETPRODUCT_BY_PRODUCTID',
    DECREASE_BASKETPRODUCT_BY_PRODUCTID_SUCCESS= 'basket/DECREASE_BASKETPRODUCT_BY_PRODUCTID_SUCCESS',
    DECREASE_BASKETPRODUCT_BY_PRODUCTID_FAILED= 'basket/DECREASE_BASKETPRODUCT_BY_PRODUCTID_FAILED',
    //
