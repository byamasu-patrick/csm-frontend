          ...
          <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center gap-2">
              <div className="text-center md:text-left mb-3 md:mb-0">
                <span className="text-gray-50 font-bold uppercase tracking-widest">
                  Newsletter
                </span>
              ...
              <form className="w-full md:max-w-md flex gap-2">
                <input
                  placeholder="Email"
                  className="w-full flex-1 bg-white text-gray-700 placeholder-gray-400 border border-gray-200 focus:ring ring-orange-300 rounded outline-none transition duration-100 px-3 py-2"
                />

                <button className="inline-block bg-white hover:bg-gray-100 focus-visible:ring ring-orange-300 text-orange-400 active:text-orange-500 text-sm md:text-base font-semibold text-center rounded outline-none transition duration-100 px-8 py-2">
                  Send
                </button>
              </form>
            </div>
        ...
        <div className="pt-12 lg:pt-16">
          <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
            ...
            <div className="text-gray-400 text-sm text-center border-t py-8">
              © 2023 - Cloud Stores Malawi. All rights reserved.
            </div>
          </div>
        </div>
      </footer>
