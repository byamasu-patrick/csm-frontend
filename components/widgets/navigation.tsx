        ...
        <div className="relative">
          ...
          <div className="dark:bg-gray-90 px-6 py-5">
            <div className="container mx-auto flex items-center justify-between">
              <h1
                className="md:w-3/12 cursor-pointer text-orange-600 dark:text-white"
                aria-label="Cloud Stores MW"
              >
                <Link href="/">
                  <a>
                    <img
              ...
              <div className="md:w-4/12 justify-end flex items-center space-x-4 xl:space-x-8">
                <div className="hidden lg:flex items-center space-x-2 xl:space-x-8">
                  <Link href="/user/carts">
                    <a
                      aria-label="go to cart"
                      className="text-gray-800 mx-6 hover:cursor-pointer hover:text-gray-900"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                      ...
                      (basketSearch.searchResult?.items.length >= 1 &&
                        cart !== null) ? (
                        <div className="inline-flex relative -top-9 -right-4 justify-center items-center w-6 h-6 text-sm font-bold text-white bg-[rgb(11,115,164)] rounded-full border-2 border-white dark:border-gray-900">
                          {cart.items.length === 0
