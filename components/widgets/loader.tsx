...
const Loader: React.FC = () => {
  return (
    <>
    <div id="defaultModal" tabIndex={-1} aria-hidden="true" className="bg-white mx-auto flex justify-center py-12 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full  h-full">
