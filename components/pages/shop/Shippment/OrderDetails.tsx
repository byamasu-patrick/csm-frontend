                    ...
                    <table className="min-w-full bg-white dark:bg-gray-800">
                        ...
                        <tbody>
                            ...
                            <tr className="h-24 border-gray-300 dark:border-gray-200 border-b">
                                ...
                                <td className="text-sm pr-6 whitespace-no-wrap text-gray-800 dark:text-gray-100 tracking-normal leading-4">
                                    <div className="relative w-10">
                                        <div className="absolute top-0 right-0 w-5 h-5 mr-2 -mt-1 rounded-full bg-orange-600 text-white flex justify-center items-center text-xs">1</div>
                            ...
                            <tr className="h-24 border-gray-300 dark:border-gray-200 border-b">
                                ...
                                <td className="text-sm pr-6 whitespace-no-wrap text-gray-800 dark:text-gray-100 tracking-normal leading-4">
                                    <div className="relative w-10">
                                        <div className="absolute top-0 right-0 w-5 h-5 mr-2 -mt-1 rounded-full bg-orange-600 text-white flex justify-center items-center text-xs">5</div>
                                        <div className="text-gray-600 dark:text-gray-400">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-file" width={28} height={28} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" />
                                                <path d="M14 3v4a1 1 0 0 0 1 1h4" />
