  ...
  return (
    <div className="">
      ...
      <div id="Main" className={`${show ? "-translate-x-full" : "translate-x-0"} bg-white transform  xl:translate-x-0 ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-64  flex-col h-full`}>
        ...
        <div className="xl:mt-6 flex flex-col justify-start items-start  px-4 w-full space-y-1 pb-4">
          <div className=" relative focus:outline-none flex jusitfy-start w-full mb-4 text-gray-800 rounded  items-center border-gray-300 focus:border-gray-400 border  ">
          ...
          <button className="focus:outline-none flex jusitfy-start hover:bg-gray-100 text-gray-600 rounded py-3 pl-4 items-center space-x-2 w-full ">
          ...
          <button className="focus:outline-none flex jusitfy-start hover:bg-gray-100 text-gray-600 rounded py-3 pl-4  items-center w-full  space-x-2">
            <input id="default-checkbox" type="checkbox" value="" className="w-4 h-4 text-orange-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
            <p className="text-base leading-4 ">Sort by Date</p>
          </button>
          <button className="focus:outline-none flex justify-start items-center space-x-2   hover:bg-gray-100 text-gray-600 rounded  py-3 pl-4  w-full ">
            <input id="default-checkbox" type="checkbox" value="" className="w-4 h-4 text-orange-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
            <p className="text-base leading-4  ">High Rated Product</p>
          </button>
          <button className="flex justify-start items-center space-x-2  focus:outline-none  hover:bg-gray-100 text-gray-600 rounded py-3 pl-4  w-full ">
            <input id="default-checkbox" type="checkbox" value="" className="w-4 h-4 text-orange-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
        ...
        <div className="mt-6 flex flex-col justify-start items-start  px-4 w-full space-y-1 pb-4">
