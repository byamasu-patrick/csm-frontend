    ...
    <div className="container mx-auto my-5 p-5">
        <div className="md:flex no-wrap md:-mx-2 ">
                    ...
                    <ul
                        ...
                        <li className="flex items-center py-3">
                            ...
                            <span className="ml-auto"><span
                                    className="bg-orange-500 py-1 px-2 rounded text-white text-sm">Active</span></span>
                        </li>
                        <li className="flex items-center py-3">
            ...
            <div className="w-full md:w-9/12 mx-2 h-64">
                ...
                <button
                    className="block w-full main-txt text-sm font-semibold rounded-lg  hover:shadow-xs p-3 my-4">Show
