...
const Shippments: NextPageWithLayout = () => {
    ...
    const title: string = "Shippment catalog";
          ...
          <div className="max-w-2xl mx-auto px-2 sm:px-6 lg:max-w-5xl lg:px-2">           
            <div className=" py-2  md:flex md:items-center md:justify-between">
              <div className="px-4 sm:px-6 md:px-0">
                <h1 className="text-3xl font-extrabold text-gray-900">Shippments</h1>
              </div>             
            </div>
...
Shippments.getLayout = function getLayout(page: ReactElement){
