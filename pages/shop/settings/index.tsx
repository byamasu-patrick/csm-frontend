                ...
                <div className="md:flex no-wrap md:-mx-2 ">
                    <div className="w-full md:w-3/12 md:mx-2">
                        <div className="bg-white p-3 border-t-4 border-orange-400">
                            ...
                            <h1 className="text-gray-900 font-bold text-xl leading-8 my-1">{user?.profile?.firstName +" "+ user?.profile?.lastName}</h1>
                            <h3 className="text-gray-600 font-lg text-semibold leading-6">{user?.userType}</h3>
                            ...
                            <div className="text-gray-700">
                                <div className="grid md:grid-cols-2 text-sm">
                                    <div className="grid grid-cols-2">
                                        ...
                                        <div className="px-4 py-2">{user?.profile?.firstName}</div>
                                    </div>
                                    <div className="grid grid-cols-2">
                                    ...
                                    <div className="grid grid-cols-4">
                                        ...
                                        <div className="px-4 py-2">
                                            <a className="text-blue-800" href={user?.email.trim()}>{user?.email.trim()}</a>
                                        </div>
                                    </div>
                                    <div className="grid grid-cols-2">
