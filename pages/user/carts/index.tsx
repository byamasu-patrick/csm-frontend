        ...
        <>
            <div>
                <div className="flex items-center justify-center h-full w-full bg-opacity-90 top-0 overflow-y-auto overflow-x-hidden sticky-0 py-12" id="chec-div">
                    <div className="w-10/12 m-0 z-10 right-0 h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700" id="checkout">
                            ...
                            <div className="xl:w-1/2 md:w-1/3 w-full bg-gray-100 h-auto">
                                <div className="flex flex-col md:h-screen px-14 py-20 justify-between overflow-y-auto">
                                    ...
                                    <div>
                                        ...
                                        <button onClick={() => setShow(!show)} className="text-base leading-none w-full py-5 bg-orange-500 border-orange-500 border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 text-white">
                                            Checkout
                                        </button>
                                    </div>
                                </div>
