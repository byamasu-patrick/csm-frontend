...
import { BasketSelector, GetOrderedProductsByUsername } from "../../libs/store/Basket";
    ...
    return (        
        <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
            <div className="flex justify-start item-start space-y-2 flex-col ">
                <h1 className="text-3xl lg:text-4xl font-semibold leading-7 lg:leading-9  text-gray-800">Your Ordered Products</h1>
            </div>
            {
                isOrdersFetched ? (
                                            ...
                                            return (                                               
                                                <div key={ind + index} className="mt-4 md:mt-6 flex  flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full ">
                                                    <div className="pb-4 md:pb-8 w-full md:w-40">
                                                        <img className="w-full hidden md:block" src={productData.imageFile} alt="dress" />
                                                    </div>
                                                    <div className="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full  pb-8 space-y-4 md:space-y-0">
                                                        <div className="w-full flex flex-col justify-start items-start space-y-8">
                                                            <h3 className="text-xl xl:text-2xl font-semibold leading-6 text-gray-800">{productData.name}</h3>
                            ...
                            <div className="flex justify-center md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
                                <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full space-y-6   ">
                                    ...
                                    <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                                        <div className="flex justify-between  w-full">
                                            ...
                                            <p className="text-base leading-4 text-gray-600">K 175000.00</p>
                                        </div>
                                        <div className="flex justify-between items-center w-full">
                                            <p className="text-base leading-4 text-gray-800">
                                                Discount <span className="bg-gray-200 p-1 text-xs font-medium leading-3  text-gray-800">STUDENT</span>
                                            </p>
                                            <p className="text-base leading-4 text-gray-600">K -65750.00 (50%)</p>
                                        </div>
                                        <div className="flex justify-between items-center w-full">
                                            <p className="text-base leading-4 text-gray-800">Shipping</p>
                                            <p className="text-base leading-4 text-gray-600">K 5600.00</p>
                                        </div>
                                    </div>
                                    <div className="flex justify-between items-center w-full">
                                        <p className="text-base font-semibold leading-4 text-gray-800">Total</p>
                                        <p className="text-base font-semibold leading-4 text-gray-600">K 88336.00</p>
                                    </div>
                                </div>
                                <div className="flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full space-y-6   ">
                                    ...
                                    <div className="flex justify-between items-start w-full">
                                        ...
                                        <p className="text-lg font-semibold leading-6 text-gray-800">K 5600.00</p>
                                    </div>
                                    <div className="w-full flex justify-center items-center">
                                        <button className="hover:bg-orange focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 py-5 w-96 md:w-full hover:bg-orange-600 bg-orange-500 text-base font-medium leading-4 text-white">View Carrier Details</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex  flex-col md:flex-row xl:flex-col justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0 ">
                                <div className="flex flex-col justify-start items-start flex-shrink-0">
                                    <div className="flex justify-center  w-full  md:justify-start items-center space-x-4 py-8 border-b border-gray-200">
                                        ...
                                        <div className=" flex justify-start items-start flex-col space-y-2">
                                            <p className="text-base font-semibold leading-4 text-left text-gray-800">{user?.profile?.firstName +" "+ user?.profile?.lastName}</p>
                                ...
                                <div className="w-full flex justify-between xl:h-full  items-stretch w-full flex-col mt-6 md:mt-0">
                                    <div className="flex justify-center md:justify-start xl:flex-col flex-col md:space-x-6 lg:space-x-8 xl:space-x-0 space-y-4 xl:space-y-12 md:space-y-0 md:flex-row  items-center md:items-start ">
                                        <div className="flex justify-center md:justify-start  items-center md:items-start flex-col space-y-4 xl:mt-8">
                                            <p className="text-base font-semibold leading-4 text-center md:text-left text-gray-800">Billing Address Details</p>
                                                ...
                                                </div>
                                                {
                                                    billingAddresses.length > 0 ? (
                                                        billingAddresses.map((billing, index) => {
                                                            return (
                                                                <div 
                                                                    key={billing.firstName+billing.id} className="w-full shadow-sm bg-white px-4 py-4 rounded-md flex justify-center md:justify-start  items-center md:items-start flex-col ">
                                                                    <p className="w-full font-semibold text-center md:text-left text-sm leading-5 text-gray-600 text-md">{billing.cardName}</p>
                                                                    <p className="flex justify-between w-full font-semibold text-center md:text-left text-sm leading-5 text-gray-600 "><span className="txt-lg">Card Number: {billing.cardNumber.substring(0, 4)}-{billing.cardNumber.substring(4, 8)}-{billing.cardNumber.substring(8, 12)}****</span>
                                                                    
                                                                    </p>
                                                                    <p className="font-semibold w-full text-center md:text-left text-sm leading-5 text-gray-600">Expires: {billing.expiration}</p>
                                                                </div>
                                                            )
                                                        })
                                                    ) : (<></>)
                                    ...
                                    <div className="pt-6 flex w-full justify-center items-center md:justify-start md:items-start">
                                        <button className="mt-6 md:mt-0 py-5 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-600 border border-orange-600 font-medium w-96 2xl:w-full text-base leading-4 text-orange-600">Edit Details</button>
                                    </div>
                                </div>
                            </div>
                        </div>
